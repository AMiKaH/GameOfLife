 ...
 *
 */
public class Carnivore extends Animal implements OmnivoreEdible, Serializable {
	...
	public boolean validate(ArrayList<Cell> neighbors) {
		...
		for (int i = 0; i < size; i++) {
			if (neighbors.get(i).getSpecies() instanceof CarnivoreEdible ||
	...
	public boolean edible(Cell cell) {
		if (cell.getSpecies() instanceof CarnivoreEdible) {
			return true;
		} else {
			return false;
		}
